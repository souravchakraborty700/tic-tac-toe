...
# Function that indicates if a space is freely available:
...
def replay():
    ...
    return input("Do you want to replay again? Enter Yes or No: ").lower().startswith('y')
...
while True:
    ...
    while game_on == True:
        ...
        if turn == 'Player 1':
            ...
            win_check(theBoard, player_2_marker)
